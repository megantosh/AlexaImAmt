...
JavaScript Documentation & \shortstack[l]{\url{https://developer.mozilla.org/en-US/docs/Web/JavaScript} \\(Mozzila Developer Network)}\\
...
Glossary & \shortstack[l]{
\url{https://developer.amazon.com/docs/ask-overviews/alexa-skills-kit-glossary.html}\\ \url{https://developer.amazon.com/designing-for-voice/glossary/}}\\
...
\shortstack[l]{\url{https://developer.amazon.com/docs/smapi/interaction-model-schema.html} \\
...
Utterances and Slot Types & \shortstack[l]{https://developer.amazon.com/docs/custom-skills/create-intents-utterances-and-slots.html \\  \url{https://developer.amazon.com/docs/custom-skills/best-practices-for-sample-utterances-and-custom-slot-type-values.html}}\\
...
\shortstack[l]{\url{https://github.com/skilltemplates/api-starter-alexa} \\ 
\url{https://http://skilltemplates.com}}\\ 
Node.js code &
...
Alexa Server Simulation (Deprecated) & \shortstack[l]{
\url{https://github.com/alexa-js/alexa-app-server/tree/master/examples} \\ \url{https://github.com/matt-kruse/alexa-app}}\\

ASK for Java & \url{https://github.com/alexa/alexa-skills-kit-sdk-for-java}\\

Sample Skills & \shortstack[l]{\url{https://github.com/alexa/skill-sample-nodejs-fact} \\ \url{https://github.com/alexa/skill-sample-nodejs-howto/blob/master/instructions/1-voice-user-interface.md} \\ \url{https://github.com/alexa/skill-sample-nodejs-decision-tree}}\\
...
& (Federal Catalogue of Public %administration 
services )\\
