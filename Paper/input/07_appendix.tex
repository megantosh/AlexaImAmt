...
\url{https://developer.amazon.com/docs/smapi/interaction-model-schema.html} and
...
\url{https://github.com/skilltemplates/api-starter-alexa} and 
...
\url{https://github.com/alexa-js/alexa-app-server/tree/master/examples} and https://github.com/matt-kruse/alexa-app\\

ASK for Java & \url{https://github.com/alexa/alexa-skills-kit-sdk-for-java}\\

Sample Skill & \url{https://github.com/alexa/skill-sample-nodejs-fact} and \url{https://github.com/alexa/skill-sample-nodejs-howto/blob/master/instructions/1-voice-user-interface.md} and \url{https://github.com/alexa/skill-sample-nodejs-decision-tree}\\
