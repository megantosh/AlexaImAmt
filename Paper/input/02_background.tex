...
\subsection{Terminology} \todo{explain json}
\begin{itemize}
	\item[intent]
	\item[utterance]
	\item [slot]
...
\todo{don't mention you're using lambda until design chapter 3}
...
here you can talk about alternatives like Microsoft, etc, compare pricing scheme, say why you chose alexa (for its popularity mainly and 3ashan Api.ai et3amal abl keda
