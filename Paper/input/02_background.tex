...
\todo{
	...
	\textbf{more on AI in bots (optional)}
	\textcolor{magenta}{
		- use of ML\\
...
\todo{	- difference alexa + AVS / Lex \& Polly\\

}


\subsection{Node.js}
\todo{why node js: event-driven, non-blocking I/O model}
\subsection{Alexa Skills, Amazon Voice Services}
\subsection{comparison to Amazon Lex / Amazon Polly}
