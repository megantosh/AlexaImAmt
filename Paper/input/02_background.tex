...
Started out of an amateur project and officially launched in December 2017, the chatbot is developed for Vienna, Austria by \inote{Sindre Wimberger}
...
\begin{figure}[h!]
	\caption{Primary Nodes of \mintinline{java}{Dienstleistungen.json}}
	\includegraphics[width=\textwidth]{DLprim}
\end{figure}

\begin{figure}[h]
	\caption{Secondary Nodes of \mintinline{java}{Dienstleistungen.json}}
