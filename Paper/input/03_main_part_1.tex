...
Based on our own exploration and through a growing voice design guide offered to Alexa developers \footnote{\url{https://alexa.design/guide} \\ \href{https://developer.amazon.com/designing-for-voice/what-alexa-says/}{\lstinline|//developer.amazon.com/designing-for-voice/voice-design-checklist|}\\
	\href{https://developer.amazon.com/designing-for-voice/design-process/}{\lstinline|//developer.amazon.com/designing-for-voice/voice-design-checklist|}\\
	\href{https://developer.amazon.com/designing-for-voice/voice-design-checklist}{\lstinline|//developer.amazon.com/designing-for-voice/voice-design-checklist|}
...
%\begin{quotation}
\begin{tikzpicture}
\calloutquote[width=4.7cm,position={(-0.7,0.2)},fill=lightgray!50,rounded corners]{
...
\begin{flushright}
\begin{tikzpicture}
\calloutquote[width=9.3cm,position={(0.5,0.2)},fill=gray!50,rounded corners]{
...
\begin{tikzpicture}
\calloutquote[width=2.7cm,position={(-0.7,0.2)},fill=lightgray!50,rounded corners]{
